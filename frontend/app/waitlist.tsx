      ...
      <View style={[styles.container, styles.doneWrap, { paddingTop: insets.top }]} testID="waitlist-success">
        ...
        {ambassador && (
          <Text style={styles.doneText}>
            {"We'll also reach out about becoming an Orrbbit ambassador in "}{city}.
          </Text>
        )}
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      ...
      >
        ...
        <Text style={styles.sub}>
          {"Orrbbit isn't live in your city yet. Join the waitlist and be first to know when it launches near you."}
        </Text>
        ...
        <View style={styles.ambRow}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.ambText}>Help launch Orrbbit in your city and host 100m social experiments.</Text>
          </View>
