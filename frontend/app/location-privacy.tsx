...
const CARDS = [
  ...
  { icon: "resize", title: "Radius depends on your plan", text: "Free users can discover people within 50m. Plus unlocks 100m. Pro unlocks extended discovery up to 500m." },
