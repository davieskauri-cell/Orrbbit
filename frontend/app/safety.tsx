...
export default function SafetyScreen() {
  ...
  const doReport = async (reason: string) => {
    ...
    setMode(null);
    showAlert("Report sent", "Thanks for keeping IntroU safe. Our team will review it.");
  };
  ...
  return (
    ...
    >
      ...
      <Text style={styles.sub}>
        IntroU is designed for real-world connection, but you are always in control.
      </Text>
