        ...
        <>
          ...
          <View style={[styles.reportCard, shadow.card]}>
            ...
            <Text style={styles.eventSummary}>
              “{data.trial_metrics.conversations_confirmed} conversations started through Intro tonight.”
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  riskChip: { paddingHorizontal: spacing.sm, paddingVertical: 3, borderRadius: 999 },
  ...
  actionBtn: { backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingHorizontal: spacing.md, paddingVertical: 7 },
