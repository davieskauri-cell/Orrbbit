    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={s.root}>
      <View style={s.card}>
        <View style={s.brandRow}>
          ...
          <View>
            <Text style={s.brand}>IntroYu Control Centre</Text>
            <Text style={s.sub}>Administrator access only</Text>
          </View>
        </View>
        <Text style={s.label}>Email</Text>
        <Input placeholder="admin@introyu.app" autoCapitalize="none" keyboardType="email-address" value={email} onChangeText={setEmail} />
