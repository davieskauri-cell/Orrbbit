...
const NAV: { label: string; path: string; icon: any; soon?: number }[] = [
  ...
  { label: 'People Radar', path: '/control/people-radar', icon: 'locate-outline', soon: 2 },
  { label: 'Professional Radar', path: '/control/professional-radar', icon: 'navigate-outline', soon: 2 },
  { label: 'Connections', path: '/control/connections', icon: 'git-network-outline', soon: 2 },
  { label: 'Chats', path: '/control/chats', icon: 'chatbubbles-outline', soon: 2 },
  { label: 'Reports', path: '/control/reports', icon: 'flag-outline' },
  { label: 'Notifications', path: '/control/notifications', icon: 'notifications-outline', soon: 2 },
  { label: 'Analytics', path: '/control/analytics', icon: 'bar-chart-outline', soon: 2 },
  { label: 'Marketing', path: '/control/marketing', icon: 'megaphone-outline', soon: 3 },
  { label: 'Content Management', path: '/control/content-management', icon: 'document-text-outline', soon: 3 },
  { label: 'Categories', path: '/control/categories', icon: 'pricetags-outline', soon: 3 },
  { label: 'Subscriptions', path: '/control/subscriptions', icon: 'card-outline', soon: 3 },
  { label: 'Payments', path: '/control/payments', icon: 'cash-outline', soon: 3 },
  { label: 'Feature Flags', path: '/control/feature-flags', icon: 'toggle-outline', soon: 2 },
  { label: 'System Health', path: '/control/system-health', icon: 'heart-outline', soon: 2 },
  { label: 'Audit Logs', path: '/control/audit-logs', icon: 'receipt-outline' },
  { label: 'Admin Users', path: '/control/admins', icon: 'key-outline' },
  { label: 'Emergency Controls', path: '/control/emergency-controls', icon: 'warning-outline', soon: 2 },
  { label: 'Settings', path: '/control/settings', icon: 'settings-outline', soon: 2 },
];
  ...
  const sidebar = (
    <View style={[st.sidebar, compact && st.sidebarOverlay]}>
      <View style={st.brand}>
        ...
        <View>
          <Text style={st.brandText}>INTRO</Text>
...
const st = StyleSheet.create({
  ...
  searchDrop: { position: 'absolute', top: 44, left: 0, right: 0, backgroundColor: CC.surface, borderRadius: 10, borderWidth: 1, borderColor: CC.border, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 12, elevation: 6, paddingVertical: 4 },
  ...
  profileDrop: { position: 'absolute', top: 54, right: 20, backgroundColor: CC.surface, borderRadius: 10, borderWidth: 1, borderColor: CC.border, padding: 14, gap: 6, zIndex: 60, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 12, elevation: 6, minWidth: 220 },
