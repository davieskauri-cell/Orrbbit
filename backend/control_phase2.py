"""INTRO Control Centre — Phase 2 modules.
...
CONFIG_DEFS = [
    ...
    {"key": "maintenance_message", "label": "Maintenance mode message", "default": "Intro is briefly down for maintenance. Please try again soon."},
]
